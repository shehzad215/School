   ...
   <div class="px-5 px-sm-20">
      <div class="grid columns-12 gap-4 gap-y-5">
         <div class="intro-y g-col-12 g-col-sm-6">
             ...
             <input id="name" type="text" name="name" class="form-control" placeholder="Role Name" value="{{ $role->name }}" required>
         </div> 
         <div class="intro-y g-col-12 g-col-sm-6">
             <label for="name" class="form-label">Status</label>
             <br>
              <label class="radio-inline">
               <input type="radio" name="active" value="1" {{ $role->active == 1 ? "checked" : '' }}>Active
             </label>
             <label class="radio-inline">
               <input type="radio" name="active" value="0" {{ $role->active == 0 ? "checked" : '' }}>In-active
             </label>
         </div>   
