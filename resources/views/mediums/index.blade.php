...
<div class="w-full w-sm-auto d-flex mt-4 mt-sm-0">
    <a class="d-flex align-items-center me-3" href="{{ route('mediums.create') }}"> 
...
<div class="intro-y box p-5 mt-5">
     <div class="intro-y g-col-12 ooverflow-x-auto overflow-lg-visible mt-5">
        <table class="table table-report mt-n2">
            <thead>
                <tr>
                    <th class="text-nowrap">Medium</th>
             ...
             <tbody>
                 @foreach ($mediums as $medium)   
                  <tr class="intro-x">
                    ...
                    <td>
                        @php 
                        $active = ($medium->active == 1) ? 'checked' : '';
                        @endphp
                     ...
                     <td class="table-report__action w-56">
                        <div class="d-flex justify-content-start align-items-center">
                            <a class="d-flex align-items-center me-3" href="{{ route('mediums.edit',$medium->id) }}"> 
